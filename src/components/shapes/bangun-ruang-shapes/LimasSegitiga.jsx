/**
 * Renders the LimasSegitiga calculator card.
 *
...
export default function LimasSegitiga({ label, img }) {
  ...
  const calculateSurfaceArea = () => {
    ...
    if (
      isNaN(baseAreaValue) ||
      isNaN(basePerimeterValue) ||
      isNaN(slantHeightValue) ||
      baseAreaValue <= 0 ||
      basePerimeterValue <= 0 ||
      slantHeightValue <= 0
    )
      return setResultLines(["Input tidak valid"]);
    setResultLines([
